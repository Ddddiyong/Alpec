...
$(function () {
    ...
    $('.vis-depth1 > li').on('click', function () {
        ...
        // $('.vis-depth2').removeClass('show');
        $(this).children('.vis-depth2').toggleClass('show');
    });
    $('.vis-depth2').mouseout(function(){
        $(this).removeClass('show');
    })
    $('.vis-depth2').mouseover(function(){
        $(this).addClass('show');
    })

    $('.vis-depth1 > li').mouseout(function () {
        // $(this).children('.vis-depth2').stop().slideUp();
        $(this).children('.vis-depth2').removeClass('show');
        console.log('out')
    });
})
